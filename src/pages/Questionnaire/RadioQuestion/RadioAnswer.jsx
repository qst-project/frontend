...
const RadioAnswer = ({label, selectRadio, questionID, answerID, checked}) => {
  ...
  return (
    <button data-cy="RadioAnswer" onClick={() => selectRadio(questionID, answerID)} value={label} className='group trans-bg bg-light-highlight dark:bg-dark-highlight mt-2 block py-[10px] pl-4 pr-[30px] rounded-full cursor-pointer'>
      {checked ? 
