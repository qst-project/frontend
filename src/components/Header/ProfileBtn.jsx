...
const ProfileBtn = () => {
  return (
    <button className='group relative pl-4 ml-4 flex items-center'>
      ...
      <p className='trans-text text-white dark:text-grey-8 z-10 mr-3'>Profile</p>
      <svg className='z-10 mr-[5px]' width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
