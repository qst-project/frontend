    ...
    <div className='flex' onMouseEnter={showRemoveBtn} onMouseLeave={hideRemoveBtn}>
      ...
      <div className='relative mt-1'>
        <TextareaAutosize 
          ...
          className='py-2.5 pl-12 pr-4 bg-blue-006 text-sm text-light-text-1 resize-none focus:outline focus:outline-1 focus:outline-light-text-1'/>
      ...
      className='group opacity-0 transition-opacity duration-300 p-2 self-center bg-blue-006 rounded-xl ml-2'>
