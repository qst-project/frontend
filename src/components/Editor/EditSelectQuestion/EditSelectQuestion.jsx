  ...
  return (
    <div className='my-gradient-box w-full mb-10 p-9 rounded-[33px]'>
      ...
      <div className='mb-6 w-full flex'>
        ...
        className='px-4 h-10 basis-full bg-blue-006 rounded-xl text-base text-light-text-1 focus:outline focus:outline-1 focus:outline-light-text-1'></input>
        <button onClick={() => removeQuestion(question.id)} data-tip='Remove question' data-for='global-tip' className='group p-2 bg-blue-006 rounded-xl ml-2'>
